...
import pytest
from jarvis_core.memory.strategic import StrategicMemoryStore, store_goal_snapshot, trajectory_delta
...
class TestStrategicMemoryStore:
    ...
    def test_retrieve_latest_snapshot(self, store):
        ...
        snapshot = {"goal_id": "goal_001", "title": "Test goal", "progress": 0.5}
...
class TestTrajectoryDelta:
    ...
    def test_delta_with_complex_values(self):
        ...
        prev = {"goal_id": "g1", "tasks": ["task1", "task2"], "metadata": {"priority": "high"}}
        curr = {
            "goal_id": "g1",
