...
import pytest
from jarvis_core.application.services.memory_migration import MemoryMigration
...
class TestMemoryMigration:
    ...
    def test_fix_missing_required_fields_strategic(self):
        ...
        memory = Memory(
            key="goal_test_002", type=MemoryType.STRATEGIC, content={}  # Missing required fields
        )
    ...
    def test_fix_missing_knowledge_fields(self):
        ...
        memory = Memory(key="know_test_002", type=MemoryType.KNOWLEDGE, content={})
    ...
    def test_fix_confidence_out_of_range(self):
        ...
        memory = Memory(
            key="know_test_003",
            type=MemoryType.KNOWLEDGE,
            content={"title": "Test", "content": "Test", "confidence": 1.5},  # Out of range
        )
    ...
    def test_fix_missing_execution_log_fields(self):
        ...
        memory = Memory(key="exec_test_002", type=MemoryType.EXECUTION_LOG, content={})
    ...
    def test_validate_valid_working_memory(self):
        ...
        memory = Memory(
            key="work_test_001", type=MemoryType.WORKING, content={"data": {"key": "value"}}
        )
    ...
    def test_fix_missing_working_memory_data(self):
        ...
        memory = Memory(key="work_test_002", type=MemoryType.WORKING, content={})
    ...
    async def test_migrate_memory_same_version(self):
        ...
        memory = Memory(
            ...
            type=MemoryType.STRATEGIC,
            content={"goal": "Test", "priority": "medium", "status": "active"},
        )
