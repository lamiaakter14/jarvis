...
check_item "Application directory exists" "[ -d /home/jarvis/jarvis ]"
check_item "Git repository is valid" "cd /home/jarvis/jarvis && git status"
check_item ".env file exists" "[ -f /home/jarvis/jarvis/.env ]"
check_item "Python virtual environment exists" "[ -d /home/jarvis/jarvis/venv ]"
check_item "Frontend build directory exists" "[ -d /home/jarvis/jarvis/apps/web/dist ]" || warning_item "Frontend not built (run: npm run build)"

section "Environment Variables"
check_item "DATABASE_URL is set" "grep -q 'DATABASE_URL=' /home/jarvis/jarvis/.env"
check_item "REDIS_URL is set" "grep -q 'REDIS_URL=' /home/jarvis/jarvis/.env"
check_item "OPENAI_API_KEY is set" "grep -q 'OPENAI_API_KEY=' /home/jarvis/jarvis/.env"
check_item "JWT_SECRET_KEY is set" "grep -q 'JWT_SECRET_KEY=' /home/jarvis/jarvis/.env"
check_item "ENVIRONMENT is set to production" "grep -q 'ENVIRONMENT=production' /home/runner/jarvis/.env" || warning_item "ENVIRONMENT not set to production"
