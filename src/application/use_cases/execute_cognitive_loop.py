...
from src.shared.utils import current_date, current_timestamp
...
class ExecuteCognitiveLoop:
    ...
    async def execute(self) -> Dict[str, Any]:
        ...
        try:
            ...
            await self.notification_service.send_notification(
                "Starting cognitive loop: Strategist phase",
                "info"
            )
            ...
            await self.notification_service.send_notification(
                "Cognitive loop: Innovator phase",
                "info"
            )
            ...
            await self.notification_service.send_notification(
                "Cognitive loop: Amplifier phase",
                "info"
            )
    ...
    async def _run_strategist(self, today) -> Dict[str, Any]:
        ...
        try:
            # Generate daily plan
            plan_dto = await self.plan_use_case.execute(
                target_date=today,
                available_hours=8.0
            )
