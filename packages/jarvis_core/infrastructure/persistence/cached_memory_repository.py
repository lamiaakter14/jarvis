...
class CachedMemoryRepository(IMemoryRepository):
    ...
    def __init__(
        self, repository: IMemoryRepository, cache_size: int = 128, cache_ttl_seconds: int = 300
    ):
    ...
    async def get_by_type_and_pattern(
        ...
        return await self._repository.get_by_type_and_pattern(memory_type, key_pattern)
